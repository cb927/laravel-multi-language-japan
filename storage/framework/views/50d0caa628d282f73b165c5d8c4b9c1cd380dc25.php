...
<body>
	...
	<div class="main-wrap">
		...
		<div class="container">
			<h1 class="text-center" style="margin: 50px;"><?php echo e(trans('setting_mam.mam_title')); ?></h1>
			<div class="main-container">
				<p>
					<?php echo e(trans('setting_mam.mam_summary')); ?>
				...
				<div class="consent">
					...
					<div class="consent-main">
						...
						<div>
							...
							<span><?php echo e(trans('setting_mam.mam_number')); ?></span>
							<input type="text" class="form-input">
							...
							<div class="row">
								<div class="col-md-6">
									<label for="name"><?php echo e(trans('setting_mam.mam_mail')); ?></label>
									<input type="text" class="form-input">
								</div>
								<div class="col-md-6">
									<label for="name"><?php echo e(trans('setting_mam.mam_mail')); ?></label>
							...
							<div class="row" style="margin: 30px 0;">
								<div class="center-align">
									<input type="checkbox"> <span><?php echo e(trans('setting_mam.mam_agree')); ?></span>
								</div>
							</div>
							<div class="row" style="text-align: center;">
								<p><?php echo e(trans('setting_mam.mam_content')); ?></p>
								<textarea name="" id="" rows="10"></textarea>
								<div class="center-align" style="margin-top:20px;">
									<button class="btn btn-default"><?php echo e(trans('setting_mam.mam_clear')); ?></button>
								</div>
								<div class="center-align" style="margin-top: 20px;">
									<a href="<?php echo e(route('mam.success')); ?>" class="btn btn-success"><?php echo e(trans('setting_mam.mam_send')); ?></a>
								</div>
							</div>
						</div>
					</div>
