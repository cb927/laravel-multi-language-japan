      ...
      <div class="row">
        ...
        <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12  my-page-main-content">
          ...
          <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12 d-flex-around">
            <a href="<?php echo e(url('/my-page')); ?>" class="mypage-menu mypage-menu-active"><?php echo e(trans('mypage.mypage_sumary')); ?></a>
          ...
          <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
            <div class="d-flex-center">
              <div class="green-part">
                <p><?php echo e(trans('mypage.mypage_number')); ?></p>
                <p><?php echo e(trans('mypage.mypage_remain')); ?></p>
                <p><?php echo e(trans('mypage.mypage_effective')); ?></p>
                <p><?php echo e(trans('mypage.mypage_need')); ?></p>
                <p><?php echo e(trans('mypage.mypage_margin')); ?></p>
                <p><?php echo e(trans('mypage.mypage_rate')); ?></p>
                <p><?php echo e(trans('mypage.mypage_status')); ?></p>
              </div>
              <div class="gray-part">
