        ...
        <div class="container-fluid main-area" style="height: 90%">
          <div class="row">
            <div class="text-center col-md-3 col-md-offset-1 col-sm-10 col-xs-10" style="font-size: 1.1vw; margin-top: 6%; margin-left: 7%; padding: 1% 1%; box-shadow: 8px 8px 5px gray;">
              <span class="text-center"><?php echo e(trans('demo.demo_model')); ?></span>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12 text-center main-text" style="font-size: 1.7vw; margin-top: 5%;">
              <span><?php echo e(trans('demo.demo_good')); ?></span><br>
              <span><?php echo e(trans('demo.demo_world')); ?></span>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12 text-center main-text" style="font-size: 1.6vw; font-weight: bold; margin-top: 1%">
              <span><?php echo e(trans('demo.demo_usd')); ?></span>
            </div>
          </div>
          <div class="row">
            <div class="no-input-margin-div col-md-5 col-md-offset-1 col-sm-10 col-xs-12" style="margin: 4% 1% 5% 7%; padding-top: 1%; background-color: silver; box-shadow: 8px 8px 5px gray;">
              <div class="row">
                <p style="text-align: center; font-weight: bold"><?php echo e(trans('demo.demo_info')); ?></p><br>
              </div>
              <div class="row">
                <div class="col-md-5 col-md-offset-1">
                  <input name="demo_name" placeholder="<?php echo e(trans('demo.demo_lastname')); ?>" style="width:100%; height: 45px"></input>
                </div>
                <div class="col-md-5">
                  <input name="demo_first_name" placeholder="<?php echo e(trans('demo.demo_firstname')); ?>" style="width:100%; height: 45px"></input><br><br><br>
                </div>
              </div>
              <div class="row">
                <div class="col-md-10 col-md-offset-1">
                  <input name="mail_address" placeholder="<?php echo e(trans('demo.demo_main')); ?>" style="width:100%; height: 45px"></input><br><br><br>
                </div>
              </div>
              <div class="row">
                <div class="col-md-10 col-md-offset-1">
                  ...
                  <button style="border-radius: 5px; width: 100%; margin-bottom: 5%; padding: 10px; border: none; background: green; color: white; font-weight: bold "><?php echo e(trans('demo.demo_download')); ?></button>
                </div>
              </div>
            </div>
